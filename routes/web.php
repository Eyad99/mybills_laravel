...
Route::group(
    ...
    function () {
        ...
        Route::middleware('auth')->group(function () {
            ...
            Route::get('myBills/about','client\aboutcontroller@index')->name('about');

            Route::resource('Contactus', 'client\contactusController');
        ...
        Route::resource('ContactusUs', 'contactusController');
        Route::resource('QuestionPublic','questionController');
        Route::resource('PlacePublic','placeController');
