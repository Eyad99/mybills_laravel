...
@section('title',__('site.Telecome_Bill'))
@section('content')

<!-- table -->
<div class="card mt-5">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4">@lang('site.TC')  <i class="fas fa-phone-square-alt"></i></h3>
  <div class="card-body">
      ...
      <table class="table table-bordered z-depth-5 table-responsive-lg table-striped text-center">
        <thead>
          <tr>
            ...
            <th class="text-center">@lang('site.local_calls')</th>
        ...
        <tbody>
          <tr>
            <td class="pt-3-half" >{{$bill->phone_number}}</td>
            ...
            <td class="pt-3-half" >{{$bill->local_calls}}</td>
            @isset($bill->receipt_id)
            <td class="pt-3-half" >{{$bill->payment_date}}</td>
            @endisset()
          </tr>
          <tr>
            <th class="text-center">@lang('site.adsl')</th>
            ...
            <th class="text-center">@lang('site.international_calls')</th>
        ...
        <tbody>
          <tr>
            <td class="pt-3-half" >{{$bill->servise_adsl}}</td>
            ...
            <td class="pt-3-half" >{{$bill->international_calls}}</td>
