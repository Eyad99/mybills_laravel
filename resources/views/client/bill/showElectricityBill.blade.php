...
@section('title',__('site.Electricity_Bill'))
@section('content')

<!-- table -->
<div class="card mt-5">
  <h3 class="card-header text-center font-weight-bold text-uppercase py-4">@lang('site.EC') <i class="far fa-lightbulb"></i></h3>
  <div class="card-body">
      ...
      <table class="table table-bordered z-depth-5 table-responsive-lg table-striped text-center">
        <thead>
          <tr>
            ...
            <th class="text-center">@lang('site.power')</th>
        ...
        <tbody>
          <tr>
            <td class="pt-3-half" >{{$bill->hour_number}}</td>
            ...
            <td class="pt-3-half" >{{$bill->power}}</td>
            @isset($bill->receipt_id)
          ...
          <tr>
            ...
            <th class="text-center">@lang('site.previous_visa')</th>
            <th class="text-center">@lang('site.current_visa')</th>
        ...
        <tbody>
          <tr>
            ...
            <td class="pt-3-half" >{{$bill->previous_visa}}</td>
            <td class="pt-3-half" >{{$bill->current_visa}}</td>
